...
RTF_ENTRIES = [
    ...
    ("NDCA Open Evidence Project", "Free annual repository of evidence files produced by major summer debate institutes.", "https://openev.debatecoaches.org/", "open evidence, ndca, camp files", "Briefs & Curricula"),
    ("High School PF Caselist", "Dedicated Public Forum disclosure wiki tracking team positions and citations nationally.", "https://hspf.opencaselist.com/", "pf, caselist, disclosure, opencaselist", "Prep Tools & Logic"),
    ("College Policy Caselist", "Historical and active disclosure wiki for intercollegiate policy teams (NDT/CEDA).", "https://caselist.opencaselist.com/", "policy, caselist, college, disclosure", "Prep Tools & Logic"),
    ("College LD Caselist", "Intercollegiate NFA-LD disclosure platform for single-affirmative policy-style debate.", "https://ld.opencaselist.com/", "ld, caselist, college, disclosure", "Prep Tools & Logic"),
    ...
    ("Harvard Debate Case Archive", "Public repository of historical demonstration cases and educational evidence sets.", "https://harvarddebate.org/cases", "harvard, cases, archive, policy", "Prep Tools & Logic"),
    ("Northwestern Debate File Archive", "University-hosted public archive of policy debate research and topic analysis files.", "https://www.northwestern.edu/debate/files", "northwestern, files, policy, archive", "Prep Tools & Logic"),
    ...
    ("Michigan State Debate File Vault", "Open repository distributing high school policy topic starter packs and evidence files.", "https://msudebate.com/files", "msu, files, policy, evidence", "Prep Tools & Logic"),
    ("Emory Debate File Repository", "Collegiate policy archive providing accessible research guides and historical case logs.", "https://www.emory.edu/debate/research", "emory, files, policy, research", "Prep Tools & Logic"),
    ("Kentucky Debate File Portal", "Research distribution hub maintained by the University of Kentucky debate program.", "https://ci.uky.edu/debate/files", "kentucky, files, policy, toc", "Prep Tools & Logic"),
    ("Berkeley Debate Case Library", "Curated archive of West Coast policy and parliamentary debate case outlines.", "https://berkeleydebate.com/library", "berkeley, cases, policy, archive", "Prep Tools & Logic"),
    ("Dartmouth Debate Open Research", "Summer institute evidence archive and policy research documentation portal.", "https://dartmouth.edu/~debate/research", "dartmouth, research, policy, archive", "Prep Tools & Logic"),
    ("Texas Debate Research Archive", "High school and college policy debate evidence database hosted by UT Austin.", "https://utdebate.com/research", "texas, ut, policy, research", "Prep Tools & Logic"),
    ("Cornell Debate Evidence Base", "International parliamentary and British Parliamentary motion background briefs.", "https://speechanddebate.cornell.edu/files", "cornell, bp, parliamentary, briefs", "Prep Tools & Logic"),
    ("Vermont Debate Central", "Historical portal providing evidence sets, videos, and research guides across formats.", "https://uvm.edu/~debate/central", "vermont, evidence, research, archive", "Prep Tools & Logic"),
    ("Stanford Forensic Institute Archives", "Archives of evidence files produced during summer SNFI research labs.", "https://snfi.stanford.edu/archive", "snfi, stanford, camp files, archive", "Prep Tools & Logic"),
    ("George Mason Debate File Vault", "Public policy research files focusing on urban development, environmental, and defense topics.", "https://gmu.edu/org/debate/files", "gmu, policy, files, research", "Prep Tools & Logic"),
    ("Weber State Debate Files", "Intercollegiate NFA-LD and policy debate research distribution platform.", "https://weber.edu/debate/files", "weber, ld, policy, files", "Prep Tools & Logic"),
    ...
    ("OpenEv Search Engine", "Raw index of downloadable file archives from summer camps spanning 2005 to the present.", "https://openev.s3.amazonaws.com/", "open evidence, search, camp files", "Prep Tools & Logic"),
