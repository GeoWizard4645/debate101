...
Table of Content - (Bios lines 3-32, resources, 34-197, index.html,199-2000, OldCodeBases1,... 2001+) //Last updated 2-17 /// Ctrl/Cmd + F ###RESOURCES### to find
###BIOS###
       const teamData = [
            {
                name: "Vivaan Shahani",
        ...
        const resourceCategories = [
            ...
            },
            {
                ...
                resources: [
                    ...
                    { title: "Debate 101 Instagram", desc: "Follow for circuit news, round highlights, upcoming lecture series announcements, and community features.", link: "https://www.instagram.com/thedebate.101?igsh=MW9zaDQxeTEyNHZwOA==", type: "internal", icon: "fab fa-instagram", keywords: "instagram, social media, news" },
...
<head>
    ...
    <style>
        ...
        .collab-table {
            @apply w-full text-left border-collapse mt-8 overflow-hidden rounded-sm;
        ...
        .collab-table th {
            @apply text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400 py-4 px-6 border-b border-gray-200;
        }
        .collab-table tr {
        ...
        .collab-table td {
            @apply py-6 px-6 border-b border-gray-100 text-sm align-top;
        }
        .collab-name {
            @apply mck-serif text-lg text-[#051C2C] font-bold block;
        }
        .collab-bio {
            @apply text-gray-500 italic font-light leading-relaxed;
        }
    </style>
</head>
<body class="bg-white">
    ...
    <div id="mobile-menu-overlay" class="fixed inset-0 bg-white z-[60] flex flex-col px-6 py-8">
        ...
        <div class="flex flex-col space-y-8 text-sm font-bold uppercase tracking-[0.2em] text-[#051C2C]">
            ...
            <a href="https://discord.debate101.org" target="_blank">Discord</a>
            <a href="https://instagram.debate101.org" target="_blank">Instagram</a>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-10 text-[10px] font-bold uppercase tracking-[0.2em] text-[#051C2C] items-center">
                    ...
                    <a href="https://discord.debate101.org" target="_blank" class="hover:text-[#0072b1] transition-colors">Discord</a>
                    <a href="https://instagram.debate101.org" target="_blank" class="hover:text-[#0072b1] transition-colors">Instagram</a>
    ...
    <main id="page-home" class="page-view pt-16">
        <section class="min-h-[85vh] flex items-center px-6 md:px-12 hero-section">
            ...
            <div class="max-w-5xl mx-auto w-full relative z-10 pt-12 md:pt-0">
                ...
                <div class="flex flex-col sm:flex-row gap-6">
                    ...
                    <a href="https://discord.debate101.org" target="_blank" class="border border-gray-200 text-[#051C2C] px-12 py-5 font-bold uppercase tracking-widest text-[10px] text-center hover:bg-gray-50 transition-all">Join Discord</a>
                </div>
            </div>
        </section>

        <!-- Global Resource Hub Section (CTA) -->
        ...
        <!-- Become a Known Collaborator Section -->
        <section class="py-32 px-6 md:px-12 bg-white border-y border-gray-50">
            <div class="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
                <div class="md:w-1/2">
                    <h2 class="text-[#0072b1] uppercase tracking-[0.4em] text-[10px] font-bold mb-6">Open Source Collaboration</h2>
                    <h3 class="mck-serif text-5xl text-[#051C2C] mb-8 leading-tight">Become a <span class="italic text-[#0072b1] font-normal">Known Collaborator.</span></h3>
                    <p class="text-xl text-gray-500 font-light leading-relaxed mb-10">
                        Join the collective of debaters helping scale competitive discourse. Known collaborators gain recognition on our platform and direct influence over our resource pipeline.
                    </p>
                    <button onclick="scrollToCollaborators()" class="btn-mck text-white px-12 py-5 font-bold uppercase tracking-widest text-[10px] rounded-sm">See other known collaborators</button>
                </div>
                <div class="md:w-1/2 bg-gray-50 p-12 border border-gray-100 rounded-sm shadow-sm">
                    <h4 class="text-[10px] font-bold uppercase tracking-[0.3em] text-[#051C2C] mb-8">Onboarding Protocol</h4>
                    <ul class="space-y-6">
                        <li class="flex gap-4">
                            <span class="w-6 h-6 bg-[#051C2C] text-white flex items-center justify-center text-[10px] font-bold rounded-full flex-shrink-0">1</span>
                            <p class="text-sm text-gray-600">Audit our platform and analyze the currently indexed strategic assets.</p>
                        </li>
                        <li class="flex gap-4">
                            <span class="w-6 h-6 bg-[#051C2C] text-white flex items-center justify-center text-[10px] font-bold rounded-full flex-shrink-0">2</span>
                            <p class="text-sm text-gray-600">Submit 3 resource suggestions via the <code class="bg-gray-200 px-1 rounded text-[11px]">#resource_suggestion</code> channel on Discord.</p>
                        </li>
                        <li class="flex gap-4">
                            <span class="w-6 h-6 bg-[#051C2C] text-white flex items-center justify-center text-[10px] font-bold rounded-full flex-shrink-0">3</span>
                            <p class="text-sm text-gray-600">Follow our official analysis channel on Instagram at <a href="https://instagram.debate101.org" target="_blank" class="text-[#0072b1] underline">instagram.debate101.org</a>.</p>
                        </li>
                        <li class="flex gap-4">
                            <span class="w-6 h-6 bg-[#051C2C] text-white flex items-center justify-center text-[10px] font-bold rounded-full flex-shrink-0">4</span>
                            <p class="text-sm text-gray-600">Submit your name and a brief biography in the <code class="bg-gray-200 px-1 rounded text-[11px]">#known_collabrator_request</code> channel.</p>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <main id="page-team" class="page-view hidden pt-32 px-6 md:px-12 pb-32">
        <div class="max-w-7xl mx-auto">
            ...
            <div id="team-grid" class="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-20 mb-32"></div>

            <!-- Collaborators Section -->
            <div id="collaborators-section" class="border-t pt-24 mt-24">
                <h2 class="text-[#0072b1] uppercase tracking-[0.4em] text-[10px] font-bold mb-6">Community Contribution</h2>
                <h1 class="mck-serif text-5xl text-[#051C2C] mb-12">Known Collaborators.</h1>
                <div id="collaborators-list" class="space-y-10 max-w-3xl">
                    <!-- Injected via JS -->
                </div>
            </div>
        </div>
            ...
            <div class="mb-4 flex flex-col md:flex-row justify-between items-end gap-4 border-b pb-8">
                <div>
                    ...
                    <div class="mt-4 flex items-center gap-6">
                        ...
                        <a href="https://discord.debate101.org" target="_blank" class="text-[9px] font-bold uppercase tracking-[0.2em] text-[#051C2C] hover:text-[#0072b1] flex items-center transition-colors">
    ...
    <main id="page-tools" class="page-view hidden pt-32 px-6 md:px-12 pb-32 min-h-screen bg-gray-50">
        <div class="max-w-7xl mx-auto">
            <div class="mb-12">
                ...
                <div class="inline-flex items-center gap-3 bg-yellow-50 border border-yellow-200 px-5 py-3 rounded-full mt-6 shadow-sm">
                    <span class="flex h-2 w-2 relative">
                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                        <span class="relative inline-flex rounded-full h-2 w-2 bg-red-500"></span>
                    </span>
                    <p class="text-[10px] font-bold text-yellow-800 uppercase tracking-wider">
                        System Notice: Significant token overhead and technical constraints may affect chatbot operational stability.
                    </p>
                </div>
            </div>
    ...
    <main id="page-faq" class="page-view hidden pt-32 px-6 md:px-12 pb-32 min-h-screen bg-white">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-gray-50 p-12 border border-gray-100 text-center mb-24">
                ...
                <a href="https://discord.debate101.org" target="_blank" class="btn-mck text-white px-12 py-5 font-bold uppercase tracking-widest text-[10px] rounded-sm inline-block">Join our Discord</a>
            </div>
            ...
            <div class="mb-12 border-t pt-24">
                ...
                <p class="text-gray-500 text-base font-light leading-relaxed mb-6 italic">Generic Debate AI trained on broad theory and terminology.</p>
                
                <div class="inline-flex items-center gap-3 bg-yellow-50 border border-yellow-200 px-5 py-3 rounded-full mb-12 shadow-sm">
                    <span class="flex h-2 w-2 relative">
                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                        <span class="relative inline-flex rounded-full h-2 w-2 bg-red-500"></span>
                    </span>
                    <p class="text-[10px] font-bold text-yellow-800 uppercase tracking-wider">
                        System Notice: High token overhead and ongoing implementation challenges may affect beta chatbot stability.
                    </p>
                </div>
    ...
    <footer class="bg-white border-t border-gray-100 py-20 px-6">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
            ...
            <div class="flex flex-col space-y-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">
                <a href="https://instagram.debate101.org" target="_blank" class="text-sm text-gray-600 normal-case hover:text-[#0072b1] transition-colors">Instagram</a>
                <a href="https://discord.debate101.org" target="_blank" class="text-sm text-gray-600 normal-case hover:text-[#0072b1] transition-colors">Discord</a>
            </div>
        </div>
    ...
    <script>
        ...
        const teamData = [
            ...
            {
                name: "Max Feinstein",
                role: "Co-Founder - Lead Strategist & Methodologist",
                image: "assets/max-f.png",
                blurb: "A specialist in postmodern literature and critical methodology, redefining competitive discourse through rigor.",
                depth: "About me&nbsp;<br>My name is Max Feinstein, and I am a freshman at The Altamont School in Birmingham, Alabama. This is my third year of debate and my first year competing fully on the national-circuit. Debate is my primary academic interest, and I enjoy rounds where I learn new things. Subjectivity shift is real!&nbsp;<br>Outside of debate, I play ECNL and varsity soccer for Altamont (Go Knights!) and have been playing piano, electric guitar, and acoustic guitar for quite a while. I enjoy reading extensively in both philosophy and&nbsp;other&nbsp;literature&nbsp;such as The Picture of Dorian Gray&nbsp;or&nbsp;East of Eden&nbsp;etc, and am an avid NBA fan—especially of the San Antonio Spurs. I value collaborative learning environments and enjoy working with teammates and friends to create new arguments and strategies.&nbsp;<br>Debate Background&nbsp;&amp; Argument Interests<br>I specialize primarily in Kritikal and Phil/trix debate. For the k I am most comfortable engaging with postmodern literature though fine for all k lit. I read planless affirmatives and nailbomb on occasion lol, but I am also comfortable in debating all styles.&nbsp;<br>Strategically, I am drawn to arguments that emphasize methodological and ideological evaluation, framing disputes, and real impact calculus with different weighing metric indicts rather than purely empirical cost-benefit analysis.<br>Argument preferences&nbsp;(how I can best help teach you)<br>(1 = most comfortable to teach // 5 =&nbsp;least comfortable to teach)<br>1—Kritiks, K affs, PIKs, Spark, Wipeout, K tricks (this is super underutilized), trix and other unconventional and unique arguments<br>2—PICs, Phil, S/V<br>3—Counterplans (other), Policy, Disads<br>4—Theory and procedurals<br>5—Lay debate (I can assist, but others like Max M or Vivaan may be better suited)&nbsp;<br>Email me at feinsteinm29@altamontschool.org"
            },
        ...
        const collaboratorData = [
            {
                name: "Samrajay Singh",
                bio: "A middleschool LDer at Edgemont."
            },
            {
                name: "Yuvraj Arora",
                bio: "A middleschool LDer at Edgemont."
        ...
        function scrollToCollaborators() {
            showPage('team');
            setTimeout(() => {
                const el = document.getElementById('collaborators-section');
        ...
        function initHub() {
            ...
            // Logic to move github stuff to the back and sort
            resourceCategories.forEach(cat => {
                cat.resources.sort((a, b) => {
                    const aGit = a.title.toLowerCase().includes('github') || (a.keywords && a.keywords.includes('github'));
                    const bGit = b.title.toLowerCase().includes('github') || (b.keywords && b.keywords.includes('github'));
        ...
        function initFaq() {
            ...
            const faqContent = [
                ...
                { q: "What is a Kritik (K)?", a: "A Kritik is a type of argument that challenges the philosophical, ethical, or linguistic assumptions of an opponent's case or the resolution itself. It often focuses on systemic issues like capitalism, racism, or biopower." },
                { q: "What is a Counterplan (CP)?", a: "A Counterplan is a competitive alternative to the Affirmative plan proposed by the Negative. To win, the Neg must prove the CP is better than the plan and that you cannot or should not do both (mutual exclusivity)." },
                { q: "What is Topicality (T)?", a: "Topicality is a procedural argument made by the Negative claiming the Affirmative plan does not fall within the definition of the resolution. It is a 'voting issue' because it affects fairness and education." },
                { q: "What is Theory?", a: "Theory arguments are meta-debates about the rules of the round. Debaters use theory to claim that an opponent's specific style or argument (like 'multiple conditional counterplans') is unfair and should be penalized." },
                { q: "What are 'Tricks'?", a: "Tricks are a subset of LD arguments that rely on hidden logical 'spikes' or paradoxes designed to be missed by an opponent, leading to an automatic win if conceded." },
                { q: "What is 'Spreading'?", a: "Spreading (speed reading) is a technique used to deliver arguments at a high rate of words-per-minute to maximize the amount of evidence and logic introduced in a limited speech time." },
                { q: "What is Disclosure?", a: "Disclosure is the practice of posting your evidence and case citations on the official Wiki (Tabroom/Opencaselist) before a round to allow for better-prepared, higher-level technical clashes." },
                { q: "What is a Permutation?", a: "A permutation (perm) is an Affirmative test of competitiveness against a Negative counterplan or kritik. It argues that the plan and the alternative can be done simultaneously, meaning the alternative isn't a reason to vote Neg." },
                { q: "What is 'Impact Turning'?", a: "An impact turn is when you argue that the 'bad' thing your opponent claims will happen is actually a 'good' thing (or vice-versa). For example, arguing that 'economic growth' is actually harmful due to environmental destruction." }
            ];
        ...
        function initCollaborators() {
            ...
            if (!list) return;
            list.innerHTML = collaboratorData.map(c => `
                <div class="pb-10">
                    <span class="font-bold text-[#051C2C] text-lg block">${c.name}</span>
                    <p class="text-xs text-gray-500 italic mt-1 leading-relaxed">${c.bio}</p>
                </div>
            `).join('');
        }
        ...
        // AUTO-FLOW LOGIC INITIALIZATION
        function initAutoflow() {
            ...
            <div class="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-start">
                ...
                <div class="md:w-2/3">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 text-[#051C2C]">
                        <div><p class="text-xs font-bold uppercase tracking-widest">Vivaan Shahani</p><p class="text-[10px] text-gray-400 uppercase mt-1">Lay/Trad & LARP Specialist</p></div>
                        <div><p class="text-xs font-bold uppercase tracking-widest">Max Feinstein</p><p class="text-[10px] text-gray-400 uppercase mt-1">Strategy & Critical Methodology</p></div>
                        <div><p class="text-xs font-bold uppercase tracking-widest">Max McBride</p><p class="text-[10px] text-gray-400 uppercase mt-1">Phil & Trad Specialist</p></div>
                        <div><p class="text-xs font-bold uppercase tracking-widest">Arjun Gupta</p><p class="text-[10px] text-gray-400 uppercase mt-1">Theory & K Specialist</p></div>
                    </div>
                    <button onclick="showPage('team')" class="btn-mck text-white px-10 py-4 font-bold uppercase tracking-widest text-[10px]">Meet the team</button>
                </div>
            </div>
...
<body class="bg-white">
    ...
    <script>
        ...
        function updateTimerUI() {
            ...
            const amins = Math.floor(affPrepLeft / 60);
            const asecs = affPrepLeft % 60;
            document.getElementById('prep-aff-display').innerText = `${mins.toString().padStart(2, '0')}:${secs.toString().padStart(2, '0')}`;
            document.getElementById('prep-aff-display').innerText = `${amins.toString().padStart(2, '0')}:${asecs.toString().padStart(2, '0')}`;
            document.getElementById('prep-aff-btn').innerText = prepActive === 'aff' ? 'Stop' : 'Start';
...
###MoreNosence###
//Changes to push another commit and hopefully fix github pages. Doing that again on 2/18